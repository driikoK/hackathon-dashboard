        ...
        <div className="topbar-left">
          ...
          <div className="nav-links">
            ...
            {!isRealDataset && (
              <>
                <Link 
                  to="/model-dataset/recurring-payments" 
                  className={`nav-link ${isActive('/model-dataset/recurring-payments') ? 'active' : ''}`}
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <Link 
                  to="/recurring-calendar" 
                  className={`nav-link ${isActive('/recurring-calendar') ? 'active' : ''}`}
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
